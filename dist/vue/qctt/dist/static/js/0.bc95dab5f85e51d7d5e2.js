...
webpackJsonp([0], { "0eBz": function eBz(e, t, a) {
    ...
    var i = function i() {
      var e = this,
        ...
        return a("div", { staticClass: "swiper-slide", on: { click: function click(t) {
              e.setNavOffset();
            } } }, [a("router-link", { attrs: { to: "/wangze/vuebuild" + t.addr }, domProps: { textContent: e._s(t.name) }, on: { click: function click(a) {
              e.change(t);
            } } })], 1);
      }))])]);
    },
    ...
    t = e.exports = a("FZ+f")(!0), t.push([e.i, ".swiper-nav .swiper-slide[data-v-0c625507]{width:auto;height:40px;line-height:40px}.swiper-nav[data-v-0c625507]{background:#fafafa;height:40px;width:100%;overflow:hidden}.swiper-nav .swiper-slide a[data-v-0c625507]{color:#666;font-size:16px;padding:0 10px;text-align:center;font-weight:400;font-family:Open Sans,Arial,Hiragino Sans GB,Microsoft YaHei,\\\\5FAE\\8F6F\\96C5\\9ED1,STHeiti,SimSun,sans-serif}.swiper-nav .swiper-slide a.active[data-v-0c625507],.swiper-nav .swiper-slide a.router-link-active[data-v-0c625507]{color:#17abc1;font-size:19px}", "", { version: 3, sources: ["E:/mygithub/vue/qctt/src/components/HeaderNav.vue"], names: [], mappings: "AACA,2CACE,WAAW,AACX,YAAa,AACb,gBAAiB,CAClB,AACD,6BACE,mBAAoB,AACpB,YAAY,AACZ,WAAW,AACX,eAAiB,CAClB,AACD,6CACE,WAAY,AACZ,eAAe,AACf,eAAe,AACf,kBAAmB,AACnB,gBAAmB,AACnB,4GAAqG,CACtG,AAKD,oHACE,cAAe,AACf,cAAe,CAChB", file: "HeaderNav.vue", sourcesContent: ['\n.swiper-nav .swiper-slide[data-v-0c625507]{\n  width:auto;\n  height: 40px;\n  line-height:40px;\n}\n.swiper-nav[data-v-0c625507]{\n  background: #fafafa;\n  height:40px;\n  width:100%;\n  overflow: hidden;\n}\n.swiper-nav .swiper-slide a[data-v-0c625507]{\n  color: #666;\n  font-size:16px;\n  padding:0 10px;\n  text-align: center;\n  font-weight:normal;\n  font-family: "Open Sans",Arial,"Hiragino Sans GB","Microsoft YaHei","微软雅黑",STHeiti,SimSun,sans-serif;\n}\n.swiper-nav .swiper-slide a.active[data-v-0c625507]{\n  color: #17abc1;\n  font-size:19px;\n}\n.swiper-nav .swiper-slide a.router-link-active[data-v-0c625507]{\n  color: #17abc1;\n  font-size:19px;\n}\n'], sourceRoot: "" }]);
      ...
      var e,
        ...
        function n(e) {
          ...
          if (x.container.length > 1) {
            ...
            } }, x._plugins = [];for (var H in x.plugins) {
            var W = x.plugins[H](x, x.params[H]);W && x._plugins.push(W);
...
//# sourceMappingURL=0.bc95dab5f85e51d7d5e2.js.map
//# sourceMappingURL=0.bc95dab5f85e51d7d5e2.js.map