...
webpackJsonp([0], { "0eBz": function eBz(e, t, a) {
    "use strict";
    function i(e) {
      a("O8nl");
    }var r = a("AT1x"),
  ...
  }, "8lVF": function lVF(e, t, a) {
    "use strict";
    var i = a("0eBz"),
        r = a("TVmP"),
        s = a("k1aN");t.a = { data: function data() {
        return { videoList: [] };
      }, mounted: function mounted() {
        this.$nextTick(function () {
          this.getVideoList();
        });
      }, methods: { getVideoList: function getVideoList() {
          var e = this;this.$ajax.get("/wangze/vuebuild/static/video.json").then(function (t) {
            e.videoList = t.data.data;
          }).catch(function (e) {
            console.log(e);
          });
        } }, components: { HeaderTop: i.a, FooterBottom: r.a, HeaderNav: s.a } };
      ...
      for (var t = 1; t < arguments.length; t++) {
        ...
        this.$nextTick(function () {
          ...
          this.navList.map(function (e) {
            e.checked = !1;
          }), e.checked = !0, console.log(e);
        }, getNavList: function getNavList() {
          var e = this;this.$ajax.get("/wangze/vuebuild/static/nav.json").then(function (t) {
  ...
  }, M7ml: function M7ml(e, t, a) {
    "use strict";
    var i = function i() {
      var e = this,
          t = e.$createElement,
          a = e._self._c || t;return a("div", [a("header-top"), e._v(" "), a("header-nav"), e._v(" "), a("div", [a("ul", { staticClass: "pic-list" }, e._l(e.videoList, function (t, i) {
        return a("li", { staticClass: "video_video" }, [a("a", { attrs: { href: t.video_url, target: "_self" } }, [a("div", { staticClass: "video_img seted_wh" }, [a("p", { staticClass: "word" }, [a("span", [e._v(e._s(t.title))])]), e._v(" "), a("img", { staticClass: "img video_smile_img", staticStyle: { "min-height": "210.938px", height: "auto" }, attrs: { src: t.video_img } }), e._v(" "), a("span", { staticClass: "video_play_button" }), e._v(" "), a("span", { staticClass: "video_time" }, [e._v(e._s(t.duration))])]), e._v(" "), a("p", { staticClass: "txt" }, [a("span", { staticClass: "date pubtime" }, [e._v(e._s(t.read_number))]), e._v(" "), a("span", { staticClass: "date" }, [e._v(e._s(t.source))])])])]);
  ...
  }, Xa2J: function Xa2J(e, t, a) {
    t = e.exports = a("FZ+f")(!0), t.push([e.i, ".video_video .word[data-v-22b3f670]{position:absolute;left:0;top:0;color:#fff;background:url(http://cools.qctt.cn/front/images/shipin-bj.png) repeat-x;padding:.2rem 0;font-size:.32rem;background-size:100% 100%;width:100%}.video_video a[data-v-22b3f670]{padding:0}.video_video .word span[data-v-22b3f670]{width:calc(100% - 20px);margin:0 auto;display:block}", "", { version: 3, sources: ["E:/mygithub/vue/qctt/src/page/video/index.vue"], names: [], mappings: "AACA,oCACE,kBAAmB,AACnB,OAAQ,AACR,MAAO,AACP,WAAY,AACZ,yEAA0E,AAC1E,gBAAkB,AAClB,iBAAkB,AAClB,0BAA2B,AAC3B,UAAY,CACb,AACD,gCACE,SAAU,CACX,AACD,yCACE,wBAAyB,AACzB,cAAe,AACf,aAAe,CAChB", file: "index.vue", sourcesContent: ["\n.video_video .word[data-v-22b3f670] {\n  position: absolute;\n  left: 0;\n  top: 0;\n  color: #fff;\n  background: url(http://cools.qctt.cn/front/images/shipin-bj.png) repeat-x;\n  padding: 0.2rem 0;\n  font-size: .32rem;\n  background-size: 100% 100%;\n  width: 100%;\n}\n.video_video a[data-v-22b3f670]{\n  padding:0;\n}\n.video_video .word span[data-v-22b3f670] {\n  width: calc(100% - 20px);\n  margin: 0 auto;\n  display: block;\n}\n"], sourceRoot: "" }]);
  }, "eRV+": function eRV(e, t, a) {
    "use strict";
    function i(e) {
      a("vFbp");
    }Object.defineProperty(t, "__esModule", { value: !0 });var r = a("8lVF"),
        s = a("M7ml"),
        n = a("VU/8"),
        o = i,
        l = n(r.a, s.a, !1, o, "data-v-22b3f670", null);t.default = l.exports;
    ...
    var i = function i() {
      var e = this,
        ...
        return a("div", { staticClass: "swiper-slide", on: { click: function click(t) {
              e.setNavOffset();
            } } }, [a("router-link", { class: { active: t.nav_index == e.navChecked }, attrs: { to: "/wangze/vuebuild" + t.addr }, domProps: { textContent: e._s(t.name) }, nativeOn: { click: function click(a) {
              e.setNavChecked(t.index);
            } } })], 1);
      }))])]);
    },
        r = [],
    ...
    t = e.exports = a("FZ+f")(!0), t.push([e.i, ".swiper-nav .swiper-slide[data-v-0c625507]{width:auto;height:40px;line-height:40px}.swiper-nav[data-v-0c625507]{background:#fafafa;height:40px;width:100%;overflow:hidden}.swiper-nav .swiper-slide a[data-v-0c625507]{color:#666;font-size:16px;padding:0 10px;text-align:center;font-weight:400;font-family:Open Sans,Arial,Hiragino Sans GB,Microsoft YaHei,\\\\5FAE\\8F6F\\96C5\\9ED1,STHeiti,SimSun,sans-serif}.router-link-active[data-v-0c625507],.swiper-nav .swiper-slide a.active[data-v-0c625507]{color:#17abc1;font-size:19px}", "", { version: 3, sources: ["E:/mygithub/vue/qctt/src/components/HeaderNav.vue"], names: [], mappings: "AACA,2CACE,WAAW,AACX,YAAa,AACb,gBAAiB,CAClB,AACD,6BACE,mBAAoB,AACpB,YAAY,AACZ,WAAW,AACX,eAAiB,CAClB,AACD,6CACE,WAAY,AACZ,eAAe,AACf,eAAe,AACf,kBAAmB,AACnB,gBAAmB,AACnB,4GAAqG,CACtG,AAKD,yFACE,cAAe,AACf,cAAe,CAChB", file: "HeaderNav.vue", sourcesContent: ['\n.swiper-nav .swiper-slide[data-v-0c625507]{\n  width:auto;\n  height: 40px;\n  line-height:40px;\n}\n.swiper-nav[data-v-0c625507]{\n  background: #fafafa;\n  height:40px;\n  width:100%;\n  overflow: hidden;\n}\n.swiper-nav .swiper-slide a[data-v-0c625507]{\n  color: #666;\n  font-size:16px;\n  padding:0 10px;\n  text-align: center;\n  font-weight:normal;\n  font-family: "Open Sans",Arial,"Hiragino Sans GB","Microsoft YaHei","微软雅黑",STHeiti,SimSun,sans-serif;\n}\n.swiper-nav .swiper-slide a.active[data-v-0c625507]{\n  color: #17abc1;\n  font-size:19px;\n}\n.router-link-active[data-v-0c625507]{\n  color: #17abc1;\n  font-size:19px;\n}\n'], sourceRoot: "" }]);
  ...
  }, vFbp: function vFbp(e, t, a) {
    var i = a("Xa2J");"string" == typeof i && (i = [[e.i, i, ""]]), i.locals && (e.exports = i.locals);a("rjj0")("44e8947b", i, !0);
        ...
        function n(e) {
          ...
          if (x.container.length > 1) {
            ...
            var a = l(t, "." + x.params.slideClass),
              ...
              F = Date.now(),
              Y = [];x.animating = !1, x.touches = { startX: 0, startY: 0, currentX: 0, currentY: 0, diff: 0 };var O, G;x.onTouchStart = function (t) {
            if (t.originalEvent && (t = t.originalEvent), (O = "touchstart" === t.type) || !("which" in t) || 3 !== t.which) {
              if (x.params.noSwiping && l(t, "." + x.params.noSwipingClass)) return void (x.allowClick = !0);if (!x.params.swipeHandler || l(t, x.params.swipeHandler)) {
                var a = x.touches.currentX = "touchstart" === t.type ? t.targetTouches[0].pageX : t.pageX,
                  ...
                  if (k = !0, B = !1, T = !0, S = void 0, G = void 0, x.touches.startX = a, x.touches.startY = i, z = Date.now(), x.allowClick = !0, x.updateContainerSize(), x.swipeDirection = void 0, x.params.threshold > 0 && (M = !1), "touchstart" !== t.type) {
                    var r = !0;e(t.target).is(I) && (r = !1), document.activeElement && e(document.activeElement).is(I) && document.activeElement.blur(), r && t.preventDefault();
            ...
            if (t.originalEvent && (t = t.originalEvent), !O || "mousemove" !== t.type) {
              if (t.preventedByNestedSwiper) return x.touches.startX = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, void (x.touches.startY = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY);if (x.params.onlyExternal) return x.allowClick = !1, void (k && (x.touches.startX = x.touches.currentX = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, x.touches.startY = x.touches.currentY = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, z = Date.now()));if (O && x.params.touchReleaseOnEdges && !x.params.loop) if (x.isHorizontal()) {
                if (x.touches.currentX < x.touches.startX && x.translate <= x.maxTranslate() || x.touches.currentX > x.touches.startX && x.translate >= x.minTranslate()) return;
              } else if (x.touches.currentY < x.touches.startY && x.translate <= x.maxTranslate() || x.touches.currentY > x.touches.startY && x.translate >= x.minTranslate()) return;if (O && document.activeElement && t.target === document.activeElement && e(t.target).is(I)) return B = !0, void (x.allowClick = !1);if (T && x.emit("onTouchMove", x, t), !(t.targetTouches && t.targetTouches.length > 1)) {
                if (x.touches.currentX = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, x.touches.currentY = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, void 0 === S) {
                  var a;x.isHorizontal() && x.touches.currentY === x.touches.startY || !x.isHorizontal() && x.touches.currentX === x.touches.startX ? S = !1 : (a = 180 * Math.atan2(Math.abs(x.touches.currentY - x.touches.startY), Math.abs(x.touches.currentX - x.touches.startX)) / Math.PI, S = x.isHorizontal() ? a > x.params.touchAngle : 90 - a > x.params.touchAngle);
                }if (S && x.emit("onTouchMoveOpposite", x, t), void 0 === G && (x.touches.currentX === x.touches.startX && x.touches.currentY === x.touches.startY || (G = !0)), k) {
                  if (S) return void (k = !1);if (G) {
                    ...
                    }x.params.followFinger && ((x.params.freeMode || x.params.watchSlidesProgress) && x.updateActiveIndex(), x.params.freeMode && (0 === Y.length && Y.push({ position: x.touches[x.isHorizontal() ? "startX" : "startY"], time: z }), Y.push({ position: x.touches[x.isHorizontal() ? "currentX" : "currentY"], time: new window.Date().getTime() })), x.updateProgress(E), x.setWrapperTranslate(E));
                  }
                }
              }
            }
            ...
            if (t.originalEvent && (t = t.originalEvent), T && x.emit("onTouchEnd", x, t), T = !1, k) {
              x.params.grabCursor && B && k && (!0 === x.params.allowSwipeToNext || !0 === x.params.allowSwipeToPrev) && x.setGrabCursor(!1);var a = Date.now(),
                  i = a - z;if (x.allowClick && (x.updateClickedSlide(t), x.emit("onTap", x, t), i < 300 && a - F > 300 && (L && clearTimeout(L), L = setTimeout(function () {
              ...
              }, 300)), i < 300 && a - F < 300 && (L && clearTimeout(L), x.emit("onDoubleTap", x, t))), F = Date.now(), setTimeout(function () {
                x && (x.allowClick = !0);
                ...
                if (r < -x.minTranslate()) return void x.slideTo(x.activeIndex);if (r > -x.maxTranslate()) return void (x.slides.length < x.snapGrid.length ? x.slideTo(x.snapGrid.length - 1) : x.slideTo(x.slides.length - 1));if (x.params.freeModeMomentum) {
                  ...
                  } else x.velocity = 0;x.velocity = x.velocity * x.params.freeModeMomentumVelocityRatio, Y.length = 0;var p = 1e3 * x.params.freeModeMomentumRatio,
                      d = x.velocity * p,
                      c = x.translate + d;x.rtl && (c = -c);var u,
                      m = !1,
                      g = 20 * Math.abs(x.velocity) * x.params.freeModeMomentumBounceRatio;if (c < x.maxTranslate()) x.params.freeModeMomentumBounce ? (c + x.maxTranslate() < -g && (c = x.maxTranslate() - g), u = x.maxTranslate(), m = !0, P = !0) : c = x.maxTranslate();else if (c > x.minTranslate()) x.params.freeModeMomentumBounce ? (c - x.minTranslate() > g && (c = x.minTranslate() + g), u = x.minTranslate(), m = !0, P = !0) : c = x.minTranslate();else if (x.params.freeModeSticky) {
                    var h,
            ...
            } }, x._plugins = [];for (var W in x.plugins) {
            var H = x.plugins[W](x, x.params[W]);H && x._plugins.push(H);
...
//# sourceMappingURL=0.8bef63e6de05e40cf30a.js.map
//# sourceMappingURL=0.8bef63e6de05e40cf30a.js.map