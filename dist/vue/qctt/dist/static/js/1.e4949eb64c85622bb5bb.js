...
webpackJsonp([1], { "0eBz": function eBz(e, t, a) {
    ...
    var i = a("0eBz"),
        ...
        this.$nextTick(function () {
          ...
          var e = this;this.$ajax.get("/wangze/vuebuild/static/data.json").then(function (t) {
          ...
          if (x.container.length > 1) {
            ...
            if (t.originalEvent && (t = t.originalEvent), T && x.emit("onTouchEnd", x, t), T = !1, k) {
              x.params.grabCursor && B && k && (!0 === x.params.allowSwipeToNext || !0 === x.params.allowSwipeToPrev) && x.setGrabCursor(!1);var a = Date.now(),
                  i = a - z;if (x.allowClick && (x.updateClickedSlide(t), x.emit("onTap", x, t), i < 300 && a - I > 300 && (_ && clearTimeout(_), _ = setTimeout(function () {
...
//# sourceMappingURL=1.e4949eb64c85622bb5bb.js.map
//# sourceMappingURL=1.e4949eb64c85622bb5bb.js.map