...
webpackJsonp([1], { "0eBz": function eBz(e, t, a) {
    ...
    var i = a("0eBz"),
        ...
        this.$nextTick(function () {
          new Swiper(".swiper-container", { pagination: ".swiper-pagination", loop: !1 }), this.getMsg(), this.test();
        });
      }, methods: { getMsg: function getMsg() {
          var e = this;this.$ajax.get("../../static/data.json").then(function (t) {
            console.log(t.data.data), e.msgList = t.data.data;
          }).catch(function (e) {
...
//# sourceMappingURL=1.c2702554ab9e99c6e923.js.map
//# sourceMappingURL=1.c2702554ab9e99c6e923.js.map