...
webpackJsonp([0], { "0eBz": function eBz(e, t, a) {
    ...
    var i = a("0eBz"),
        ...
        this.$nextTick(function () {
          this.getVideoList(), console.log(this);
        });
      }, methods: { getVideoList: function getVideoList() {
          var e = this;this.$ajax.get("../../static/video.json").then(function (t) {
            console.log(t.data.data), e.videoList = t.data.data;
          }).catch(function (e) {
            console.log(e);
          });
    ...
    "use strict";
    var i = a("zT5U"),
        r = (a.n(i), a("uySu"));a.n(r);t.a = { data: function data() {
        return { navList: [] };
      }, mounted: function mounted() {
        this.$nextTick(function () {
          this.getNavList();new Swiper(".swiper-nav", { slidesPerView: "auto", paginationClickable: !0, carousel: !0 });
        });
    ...
    var i = function i() {
      var e = this,
        ...
        return a("div", { staticClass: "swiper-slide" }, [a("a", { class: { active: t.checked }, attrs: { href: t.addr }, domProps: { textContent: e._s(t.name) }, on: { click: function click(a) {
              e.change(t);
            } } })]);
      }))])]);
    },
    ...
    t = e.exports = a("FZ+f")(!0), t.push([e.i, ".swiper-nav .swiper-slide[data-v-0c625507]{width:auto;height:40px;line-height:40px}.swiper-nav[data-v-0c625507]{background:#fafafa;height:40px}.swiper-nav .swiper-slide a[data-v-0c625507]{color:#666;font-size:16px;padding:0 10px;text-align:center;font-weight:400;font-family:Open Sans,Arial,Hiragino Sans GB,Microsoft YaHei,\\\\5FAE\\8F6F\\96C5\\9ED1,STHeiti,SimSun,sans-serif}.swiper-nav .swiper-slide a.active[data-v-0c625507]{color:#17abc1;font-size:19px}", "", { version: 3, sources: ["E:/mygithub/vue/qctt/src/components/HeaderNav.vue"], names: [], mappings: "AACA,2CACE,WAAW,AACX,YAAa,AACb,gBAAiB,CAClB,AACD,6BACE,mBAAoB,AACpB,WAAY,CACb,AACD,6CACE,WAAY,AACZ,eAAe,AACf,eAAe,AACf,kBAAmB,AACnB,gBAAmB,AACnB,4GAAqG,CACtG,AACD,oDACE,cAAe,AACf,cAAe,CAChB", file: "HeaderNav.vue", sourcesContent: ['\n.swiper-nav .swiper-slide[data-v-0c625507]{\n  width:auto;\n  height: 40px;\n  line-height:40px;\n}\n.swiper-nav[data-v-0c625507]{\n  background: #fafafa;\n  height:40px;\n}\n.swiper-nav .swiper-slide a[data-v-0c625507]{\n  color: #666;\n  font-size:16px;\n  padding:0 10px;\n  text-align: center;\n  font-weight:normal;\n  font-family: "Open Sans",Arial,"Hiragino Sans GB","Microsoft YaHei","微软雅黑",STHeiti,SimSun,sans-serif;\n}\n.swiper-nav .swiper-slide a.active[data-v-0c625507]{\n  color: #17abc1;\n  font-size:19px;\n}\n'], sourceRoot: "" }]);
        ...
        function n(e) {
          ...
          if (x.container.length > 1) {
            ...
            var a = l(t, "." + x.params.slideClass),
              ...
              F = Date.now(),
              Y = [];x.animating = !1, x.touches = { startX: 0, startY: 0, currentX: 0, currentY: 0, diff: 0 };var G, H;x.onTouchStart = function (t) {
            if (t.originalEvent && (t = t.originalEvent), (G = "touchstart" === t.type) || !("which" in t) || 3 !== t.which) {
              if (x.params.noSwiping && l(t, "." + x.params.noSwipingClass)) return void (x.allowClick = !0);if (!x.params.swipeHandler || l(t, x.params.swipeHandler)) {
                var a = x.touches.currentX = "touchstart" === t.type ? t.targetTouches[0].pageX : t.pageX,
                  ...
                  if (k = !0, B = !1, T = !0, S = void 0, H = void 0, x.touches.startX = a, x.touches.startY = i, z = Date.now(), x.allowClick = !0, x.updateContainerSize(), x.swipeDirection = void 0, x.params.threshold > 0 && (M = !1), "touchstart" !== t.type) {
            ...
            if (t.originalEvent && (t = t.originalEvent), !G || "mousemove" !== t.type) {
              if (t.preventedByNestedSwiper) return x.touches.startX = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, void (x.touches.startY = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY);if (x.params.onlyExternal) return x.allowClick = !1, void (k && (x.touches.startX = x.touches.currentX = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, x.touches.startY = x.touches.currentY = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, z = Date.now()));if (G && x.params.touchReleaseOnEdges && !x.params.loop) if (x.isHorizontal()) {
              ...
              } else if (x.touches.currentY < x.touches.startY && x.translate <= x.maxTranslate() || x.touches.currentY > x.touches.startY && x.translate >= x.minTranslate()) return;if (G && document.activeElement && t.target === document.activeElement && e(t.target).is(I)) return B = !0, void (x.allowClick = !1);if (T && x.emit("onTouchMove", x, t), !(t.targetTouches && t.targetTouches.length > 1)) {
                ...
                }if (S && x.emit("onTouchMoveOpposite", x, t), void 0 === H && (x.touches.currentX === x.touches.startX && x.touches.currentY === x.touches.startY || (H = !0)), k) {
                  if (S) return void (k = !1);if (H) {
            ...
            var O = x.plugins[W](x, x.params[W]);O && x._plugins.push(O);
...
//# sourceMappingURL=0.b97dd4152e2490edd331.js.map
//# sourceMappingURL=0.b97dd4152e2490edd331.js.map