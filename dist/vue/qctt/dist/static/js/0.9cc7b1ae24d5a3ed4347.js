...
webpackJsonp([0], { "0eBz": function eBz(e, t, a) {
    ...
    var i = a("NYxO"),
      ...
      for (var t = 1; t < arguments.length; t++) {
        ...
        return { navList: [], navChecked: 1, navIndex: 1, navOffset: 0 };
      }, mounted: function mounted() {
        this.$nextTick(function () {
          ...
          this.$store.commit("NAV_INDEX", e), this.$store.commit("NAV_OFFSET", this.navOffset), this.navList.map(function (e) {
            e.checked = !1;
          }), console.log(e), console.log(this.navList[e]), this.navList[e].checked = !0;
    ...
    var i = function i() {
      var e = this,
        ...
        return a("div", { staticClass: "swiper-slide", on: { click: function click(t) {
              e.setNavOffset();
            } } }, [a("router-link", { class: { active: t.nav_index == e.navIndex }, attrs: { to: "/wangze/vuebuild" + t.addr }, domProps: { textContent: e._s(t.name) }, nativeOn: { click: function click(a) {
...
//# sourceMappingURL=0.9cc7b1ae24d5a3ed4347.js.map
//# sourceMappingURL=0.9cc7b1ae24d5a3ed4347.js.map