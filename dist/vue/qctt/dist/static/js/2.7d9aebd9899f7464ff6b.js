...
webpackJsonp([2], { "0eBz": function eBz(e, t, a) {
    "use strict";
    function i(e) {
      a("O8nl");
    }var r = a("AT1x"),
  ...
  }, K6TW: function K6TW(e, t, a) {
    var i = a("uFOJ");"string" == typeof i && (i = [[e.i, i, ""]]), i.locals && (e.exports = i.locals);a("rjj0")("a174bd90", i, !0);
  }, O8nl: function O8nl(e, t, a) {
    var i = a("DaNQ");"string" == typeof i && (i = [[e.i, i, ""]]), i.locals && (e.exports = i.locals);a("rjj0")("4005b718", i, !0);
  }, Pfmx: function Pfmx(e, t, a) {
    "use strict";
    function i(e) {
      a("K6TW");
    }Object.defineProperty(t, "__esModule", { value: !0 });var r = a("e4jx"),
        s = a("VuBz"),
        n = a("VU/8"),
        o = i,
        l = n(r.a, s.a, !1, o, "data-v-50d0580e", null);t.default = l.exports;
  ...
  }, VuBz: function VuBz(e, t, a) {
    "use strict";
    var i = function i() {
      var e = this,
          t = e.$createElement,
          a = e._self._c || t;return a("div", [a("header-top"), e._v(" "), a("header-nav"), e._v(" "), a("section", [a("ul", { staticClass: "pic-list" }, e._l(e.msgList, function (t, i) {
    ...
    var i = a("0eBz"),
        ...
        this.$nextTick(function () {
          ...
          var e = this;this.$ajax.get("http://test.qctt.cn/wangze/testData/data.json").then(function (t) {
  ...
  }, uFOJ: function uFOJ(e, t, a) {
    t = e.exports = a("FZ+f")(!0), t.push([e.i, "", "", { version: 3, sources: [], names: [], mappings: "", file: "newcar.vue", sourceRoot: "" }]);
        ...
        function n(e) {
          ...
          if (x.container.length > 1) {
            ...
            var a = l(t, "." + x.params.slideClass),
              ...
              I = Date.now(),
              F = [];x.animating = !1, x.touches = { startX: 0, startY: 0, currentX: 0, currentY: 0, diff: 0 };var Y, O;x.onTouchStart = function (t) {
            if (t.originalEvent && (t = t.originalEvent), (Y = "touchstart" === t.type) || !("which" in t) || 3 !== t.which) {
              if (x.params.noSwiping && l(t, "." + x.params.noSwipingClass)) return void (x.allowClick = !0);if (!x.params.swipeHandler || l(t, x.params.swipeHandler)) {
                var a = x.touches.currentX = "touchstart" === t.type ? t.targetTouches[0].pageX : t.pageX,
                  ...
                  if (k = !0, B = !1, T = !0, S = void 0, O = void 0, x.touches.startX = a, x.touches.startY = i, z = Date.now(), x.allowClick = !0, x.updateContainerSize(), x.swipeDirection = void 0, x.params.threshold > 0 && (M = !1), "touchstart" !== t.type) {
            ...
            if (t.originalEvent && (t = t.originalEvent), !Y || "mousemove" !== t.type) {
              if (t.preventedByNestedSwiper) return x.touches.startX = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, void (x.touches.startY = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY);if (x.params.onlyExternal) return x.allowClick = !1, void (k && (x.touches.startX = x.touches.currentX = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, x.touches.startY = x.touches.currentY = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, z = Date.now()));if (Y && x.params.touchReleaseOnEdges && !x.params.loop) if (x.isHorizontal()) {
                ...
                }if (S && x.emit("onTouchMoveOpposite", x, t), void 0 === O && (x.touches.currentX === x.touches.startX && x.touches.currentY === x.touches.startY || (O = !0)), k) {
                  if (S) return void (k = !1);if (O) {
                    ...
                    }x.params.followFinger && ((x.params.freeMode || x.params.watchSlidesProgress) && x.updateActiveIndex(), x.params.freeMode && (0 === F.length && F.push({ position: x.touches[x.isHorizontal() ? "startX" : "startY"], time: z }), F.push({ position: x.touches[x.isHorizontal() ? "currentX" : "currentY"], time: new window.Date().getTime() })), x.updateProgress(E), x.setWrapperTranslate(E));
                  }
                }
              }
            }
            ...
            if (t.originalEvent && (t = t.originalEvent), T && x.emit("onTouchEnd", x, t), T = !1, k) {
              x.params.grabCursor && B && k && (!0 === x.params.allowSwipeToNext || !0 === x.params.allowSwipeToPrev) && x.setGrabCursor(!1);var a = Date.now(),
                  i = a - z;if (x.allowClick && (x.updateClickedSlide(t), x.emit("onTap", x, t), i < 300 && a - I > 300 && (L && clearTimeout(L), L = setTimeout(function () {
              ...
              }, 300)), i < 300 && a - I < 300 && (L && clearTimeout(L), x.emit("onDoubleTap", x, t))), I = Date.now(), setTimeout(function () {
                x && (x.allowClick = !0);
                ...
                if (r < -x.minTranslate()) return void x.slideTo(x.activeIndex);if (r > -x.maxTranslate()) return void (x.slides.length < x.snapGrid.length ? x.slideTo(x.snapGrid.length - 1) : x.slideTo(x.slides.length - 1));if (x.params.freeModeMomentum) {
                  if (F.length > 1) {
                    var s = F.pop(),
                      ...
                      m = !1,
                      g = 20 * Math.abs(x.velocity) * x.params.freeModeMomentumBounceRatio;if (c < x.maxTranslate()) x.params.freeModeMomentumBounce ? (c + x.maxTranslate() < -g && (c = x.maxTranslate() - g), u = x.maxTranslate(), m = !0, _ = !0) : c = x.maxTranslate();else if (c > x.minTranslate()) x.params.freeModeMomentumBounce ? (c - x.minTranslate() > g && (c = x.minTranslate() + g), u = x.minTranslate(), m = !0, _ = !0) : c = x.minTranslate();else if (x.params.freeModeSticky) {
                    var h,
                    ...
                    x && _ && (x.emit("onMomentumBounce", x), x.setWrapperTransition(x.params.speed), x.setWrapperTranslate(u), x.wrapper.transitionEnd(function () {
                      x && x.onTransitionEnd();
                    }));
            ...
            } }, x._plugins = [];for (var G in x.plugins) {
            var W = x.plugins[G](x, x.params[G]);W && x._plugins.push(W);
...
//# sourceMappingURL=2.7d9aebd9899f7464ff6b.js.map
//# sourceMappingURL=2.7d9aebd9899f7464ff6b.js.map